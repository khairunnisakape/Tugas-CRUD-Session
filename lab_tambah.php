...
<body class="bg-dark text-white">
	...
	<center>
		<br><br><br>
		<h1 class="fw-semibold fs-1">Tambah Lab Praktikum</h1>
		<hr style="margin-left: 34%; margin-right: 34%">
		<p class="fw-semibold fs-6">Tambah lab praktikum sesuai dengan yang diinginkan</p>
		<br>
		<form method="POST" action="lab_tambah_proses.php" style="margin-left: 35%; margin-right: 35%">
			<input type="text" class="form-control bg-dark text-white pt-2 pb-2" name="lab" placeholder="Masukkan Lab Praktikum" required=""><br>
			<?php  
				if(isset($_GET['message'])){
					if ($_GET['message'] == "tambah_lab_gagal") {
						echo "Tambah Lab Gagal.";
					}
				}
			?>
			<br>
